...
def write_report(
    ...
    with report_path.open("w") as f:
        ...
        f.write(f"| max memory allocated | {bytes_to_gib(metrics.get('cuda_max_memory_allocated_cross_rank_bytes', metrics.get('cuda_max_memory_allocated_bytes')))} |\n")
        f.write(f"| memory reserved | {bytes_to_gib(metrics.get('cuda_memory_reserved_bytes'))} |\n")
        f.write(f"| max memory reserved | {bytes_to_gib(metrics.get('cuda_max_memory_reserved_cross_rank_bytes', metrics.get('cuda_max_memory_reserved_bytes')))} |\n")
